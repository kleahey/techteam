...
labels = ['TPG - Sprint 1', 'TPG - Sprint 2', 'TPG - Sprint 3', 'TPG - Sprint 4', 'TPG - Sprint 5', 'TPG - Sprint 6']
data = [
  {
    label: 'Committed Velocity',
    data: [0, 20, 13, 11, 5, 21],
...
send_event('tpgBarchart', { labels: labels, datasets: data, options: options })
